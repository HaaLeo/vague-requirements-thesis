...
However, none of the mentioned approaches examines how state of the art \acp{NN} perform at classifying requirements as vague or not.
With this thesis I want to answer the question whether deep neural networks are promising in classifying requirements regarding their quality

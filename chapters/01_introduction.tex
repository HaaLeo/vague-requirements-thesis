...
Research has shown that \ac{RE} is prone to faults which can cost additional time and money \parencite{Mendez:2006} and may lead to severe project delay \parencite{Femmer:2014}.
...
Knowing reviews are costly regarding time and money, tooling which supports the \ac{RE} would be beneficial for the quality assurance process.
...
\begin{enumerate}
    ...
    \item To be defined % TODO List correct contributions
\end{enumerate}

...
\begin{enumerate}
    ...
    \item To successfully apply transfer learning one needs a set of labeled datapoints. However, as the time of writing there are no such datasets publicly available.
...
In \cref{chp:fundamentals} we establish the fundamental knowledge fundamentals which is required throughout this thesis.
...
To assess this approach is we carry out a study which we describe in depth in \cref{chp:study}.

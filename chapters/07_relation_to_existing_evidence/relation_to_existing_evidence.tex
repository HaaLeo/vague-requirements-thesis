...
With this definition they annotated $7,485$ of $21,230$ sentences to contain a propaganda technique.
...
Since the models we use correspond to the vanilla versions which use a simple feed forward \ac{NN} for the downstream classification, we consider our poor results as plausible.
